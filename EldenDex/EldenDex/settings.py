"""
Django settings for EldenDex project.
...
SECRET_KEY = 'django-insecure-zos_hjv9(xx9vyz@=n9m@w=$tk!8wt+tm_705*8db=y4aj*vwt'
...
WSGI_APPLICATION = 'EldenDex.wsgi.application'
